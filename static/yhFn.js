...
function addCssYh(element,csspara,eleIdx){
    ...
    if(dom[eleIdx]){
        dom[eleIdx].addEventListener('touchstart',addCssStart.bind(this,dom[eleIdx],csspara));
        dom[eleIdx].addEventListener('touchend',removeCssStart.bind(this,dom[eleIdx],csspara));
    }else{
